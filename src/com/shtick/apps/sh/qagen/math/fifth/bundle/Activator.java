package com.shtick.apps.sh.qagen.math.fifth.bundle;
...
import com.shtick.apps.sh.qagen.math.fifth.FifthGradeMathQuestionGenerator;
...
public class Activator implements BundleActivator {
	...
	public void start(BundleContext context){
		...
		subjectRegistration=context.registerService(SubjectQuestionGenerator.class.getName(), new FifthGradeMathQuestionGenerator(),new Hashtable<String, String>());
    }
